  ...
  if (state.hasProgram) {
    ...
    el('auto-guide').innerHTML = `
      <p class="desc" style="margin:0 0 14px">
        ...
        <b>로그인도 프로그램이 알아서</b> 합니다 — 아이디·비밀번호를 넣고
        「로그인 상태 유지」까지 켜 두니까, 한 번 들어가면 다음부터는 그냥 올라가요.
        <b>먼저 연습부터</b> 해보세요. 글은 다 채우고 등록만 안 누릅니다.
      </p>
      <p class="desc" style="margin:-8px 0 14px;font-size:13px;opacity:.75">
        처음 쓰는 계정은 네이버가 보안문자나 「새로운 기기」 확인을 물을 수 있어요.
        그때는 프로그램 창에 네이버가 한 말이 그대로 찍힙니다.
        그 계정만 <b>시작하기 → 5번</b>으로 한 번 직접 로그인해 두시면 그 뒤로는 안 물어봐요.
      </p>
      <div class="pfoot" style="margin-top:0">
